<?php
    ...
    // $posts = getPosts();
    // var_dump($posts);
    echoHeader('Computer Nerd', 'Plugged In', 'Computer Nerd', true);
    bodyPics('gaming.php?postId=1', 'heirloom.JPG', 'Apex Legends Heirloom Shards', 'Click for PC Gaming',
            ...
            'pihole.php?postId=3', 'routerpi.JPG', 'Administering Pi-hole Add Blocker', 'Click for Administering Pi-hole', false);
?>
